        ...
        <div className=' bg-gradient-to-r from-red-600 to-red-400 h-60'>
            <div className="p-5">
                ...
                <div className="grid grid-cols-5 my-5 mx-20">
                    ...
                    <button type="submit" className="col-span-1 py-2 px-3 h-16 bg-green-500 hover:cursor-pointer hover:bg-green-600 text-xl text-white"><Link href='/hotels'>Search</Link></button>
                </div>
